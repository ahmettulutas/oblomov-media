  ...
  <footer className="bg-primaryDark">
    <ContentContainer className="grid grid-cols-3 gap-4 text-md py-10">
      <div className="relative w-full col-span-3 md:col-span-1 flex flex-col">
        <p className="font-bold mb-2">Find Us Here</p>
      ...
      <div className="relative w-full col-span-3 md:col-span-1 text-center">
        <h1 className='font-bold mb-2'>Contact With Us</h1>
        <p className='text-sm text-gray-300'> Nullam viverra consectetuer quisque cursus et, porttitor risus.</p>
      </div>
      <div className="relative w-full col-span-3 md:col-span-1">
        <p className='text-sm text-gray-300 text-center'> +61 3 8376 6284 ahmetulutas93@gmail.com</p>
      </div>
    </ContentContainer>
  </footer>
);
